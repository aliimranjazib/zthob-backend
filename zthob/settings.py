...
ALINMAPAY_RETURN_URL = os.getenv('ALINMAPAY_RETURN_URL', 'https://app.mgask.net/payment-result')
ALINMAPAY_TIMEOUT_SECONDS = int(os.getenv('ALINMAPAY_TIMEOUT_SECONDS', '60'))
